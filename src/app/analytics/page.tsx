            ...
            <Card className="shadow-lg border-0 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm">
              ...
              <CardContent>
                <div className="space-y-6">
                  <div className="p-6 bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-blue-950 dark:to-indigo-950 rounded-xl border border-blue-200 dark:border-blue-800 hover-sophisticated">
                  ...
                  <div className="p-6 bg-gradient-to-br from-emerald-50 to-green-100 dark:from-emerald-950 dark:to-green-950 rounded-xl border border-emerald-200 dark:border-emerald-800 hover-sophisticated">
                    <div className="flex items-start space-x-4">
                      <div className="flex-shrink-0">
                      ...
                      <div className="flex-1">
                        <h4 className="font-semibold text-emerald-900 dark:text-emerald-100 mb-2 flex items-center">
                          ...
                          <Zap className="w-4 h-4 ml-2 text-emerald-600" />
                        </h4>
                  ...
                  <div className="p-6 bg-gradient-to-br from-amber-50 to-orange-100 dark:from-amber-950 dark:to-orange-950 rounded-xl border border-amber-200 dark:border-amber-800 hover-sophisticated">
                    <div className="flex items-start space-x-4">
                      <div className="flex-shrink-0">
                      ...
                      <div className="flex-1">
                        <h4 className="font-semibold text-amber-900 dark:text-amber-100 mb-2 flex items-center">
                          ...
                          <AlertCircle className="w-4 h-4 ml-2 text-amber-600" />
                        </h4>

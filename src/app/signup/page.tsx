...
export default function SignupPage() {
  ...
  // OAuth handlers (to be implemented when backend supports OAuth)
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              <Button
                ...
                className="h-12 border-border/50 hover:bg-accent/50 hover:border-primary/30 transition-all duration-200"
              >
